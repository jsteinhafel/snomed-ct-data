...
public abstract class ElkSnomedDataBuilderTestBaseIT extends AbstractIntegrationTest {

    private static final Logger LOG = LoggerFactory.getLogger(ElkSnomedDataBuilderTestBaseIT.class);
